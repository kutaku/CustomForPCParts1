    ...
    if (cpubtn12400.checked == true) {
        ...
        if (gpubtn3060.checked == true) {
            ...
            target.innerHTML = "<h3>12600K＆3080 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ690 / 電源GOLD850W <br>・BTO推定価格：30万円前後 <br>・フルHD360Hz / WQHD165Hzゲーミングにおすすめ！</span><br/>";
        }
    }
        ...
        if (gpubtn3060.checked == true) {
            ...
            target.innerHTML = "<h3>12700K＆3080 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ64GB / SSD2TB / マザーボードZ690 / 電源GOLD850W <br>・BTO推定価格：36万円前後 <br>・ゲーム配信 / フルHD360Hz / WQHD180Hz / 4K120Hzゲーミングにおすすめ！</span><br/>";
        }
    }
    //13世代
        ...
        if (gpubtn3060.checked == true) {
            ...
            target.innerHTML = "<h3>13400＆3060Ti SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ16GB / SSD1TB / マザーボードB760 / 電源BRONZE650W <br>・BTO推定価格：21万円前後 <br>・ゲーム配信 / 全ジャンルのフルHDゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3070.checked == true) {
        ...
        if (gpubtn3060.checked == true) {
            target.innerHTML = "<h3>13600K＆3060 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD750W <br>・BTO推定価格：27万円前後 <br>・ゲーム配信 / フルHD120Hzゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3060ti.checked == true) {
            target.innerHTML = "<h3>13600K＆3060Ti SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD750W <br>・BTO推定価格：28万円前後 <br>・ゲーム配信 / フルHD165Hzゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3070.checked == true) {
            target.innerHTML = "<h3>13600K＆3070 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD750W <br>・BTO推定価格：32万円前後 <br>・ゲーム配信 / フルHD240Hz / WQHD120Hzゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3070ti.checked == true) {
            target.innerHTML = "<h3>13600K＆3070Ti SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD750W <br>・BTO推定価格：33万円前後 <br>・ゲーム配信 / フルHD280Hz / WQHD144Hz ゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3080.checked == true) {
            target.innerHTML = "<h3>13600K＆3080 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD850W <br>・BTO推定価格：37万円前後 <br>・ゲーム配信 / フルHD360Hz /  WQHD165Hzゲーミングにおすすめ！</span><br/>";
        }
    }
        ...
        if (gpubtn3060.checked == true) {
            ...
            target.innerHTML = "<h3>13700＆3060Ti SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードB760 / 電源GOLD750W <br>・BTO推定価格：26万円前後 <br>・ゲーム配信 / フルHD165Hzゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3070.checked == true) {
            target.innerHTML = "<h3>13700＆3070 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードB760 / 電源GOLD750W <br>・BTO推定価格：28万円前後 <br>・ゲーム配信 / フルHD180Hz / WQHD120Hzゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3070ti.checked == true) {
            ...
            target.innerHTML = "<h3>13700＆3080 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD2TB / マザーボードB760 / 電源GOLD850W <br>・BTO推定価格：34万円前後 <br>・ゲーム配信 / 3Dゲーム開発 / WQHD165Hz / 4Kゲーミングにおすすめ！</span><br/>";
        }
    }
        ...
        if (gpubtn3060.checked == true) {
            target.innerHTML = "<h3>13700K＆3060 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD750W <br>・BTO推定価格：30万円前後 <br>・ゲーム配信 / 動画編集におすすめ！</span><br/>";
        } else if (gpubtn3060ti.checked == true) {
            target.innerHTML = "<h3>13700K＆3060Ti SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD750W <br>・BTO推定価格：32万円前後 <br>・ゲーム配信 / フルHD165Hzゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3070.checked == true) {
            target.innerHTML = "<h3>13700K＆3070 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD750W <br>・BTO推定価格：35万円前後 <br>・ゲーム配信 / フルHD180Hz / WQHD144Hzゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3070ti.checked == true) {
            target.innerHTML = "<h3>13700K＆3070Ti SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ32GB / SSD1TB / マザーボードZ790 / 電源GOLD850W <br>・BTO推定価格：37万円前後 <br>・ゲーム配信 / フルHD280Hz / WQHD165Hzゲーミングにおすすめ！</span><br/>";
        } else if (gpubtn3080.checked == true) {
            target.innerHTML = "<h3>13700K＆3080 SCORE</h3><br>" +
                ...
                "<span>・お勧め構成：メモリ64GB / SSD2TB / マザーボードZ790 / 電源GOLD850W <br>・BTO推定価格：45万円前後 <br>・ゲーム配信 / 3DCG制作 / WQHD180Hz / 4K120Hzゲーミングにおすすめ！</span><br/>";
        }
    }
    else {
        //選択されていない時何も表示しない
